import SideBar from "./expertSideBar"; // Assuming you have a component named ExpertsSideBar
        ...
        <div className="container mt-4">
            <div className="row">
                <aside className="col-md-3">
                    <SideBar /> {/* Changed SideBar to ExpertsSideBar */}
                </aside>
                <section className="col-md-9">
                    <div className="card">
                        ...
                        <div className="card-body">
                            ...
                            <div className="mb-3 row">
                                <label htmlFor="staticEmail" className="col-sm-2 col-form-label">Skills</label>
                                <div className="col-sm-10">
                                    <input type="text" className="form-control" id="staticEmail" />
                                </div>
                            </div>
