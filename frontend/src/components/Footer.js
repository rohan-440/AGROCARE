                ...
                <div className="row">
                    <div className="col-lg-3 mb-3">
                        ...
                        <ul className="list-unstyled small text-muted">
                            <li className="mb-2">Mobile no :  <a href="">+91 7607603669</a></li>
                            <li className="mb-2">Email : <a href="" target="_blank" rel="license noopener">AgroCare@gmail.com</a></li>
                            <li className="mb-2">Address: SRM University, Kattankalathur, Tamil Nadu , India 603203 </li>
